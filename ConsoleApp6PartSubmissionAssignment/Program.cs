...
namespace ConsoleApp6PartSubmissionAssignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string[] strings = { "a", "c", "e", "g", "i", "j", "k", "z" };
            ...
            //for (int i = 0 ;i < strings.Length && ansFound == false; i++)
            //{
            //    if (ans == strings[i])
            //    {
            ...
            //    else if (i == strings.Length -1 && ansFound == false)
            //    {
            ...
            //List<string> strings = new List<string> { "a", "b", "c", "d", "e", "e", "f", "g" };
            ...
            //List<string> list = new List<string> { "a", "b", "c", "d", "e", "c", "g" };
            ...
            //        Console.WriteLine(str + " - this item is " + strDup);
            //    }
            //    //else statement (because there are only 2 cases) to write the string is unique
            //    else
            //    {
            //        Console.WriteLine(str + " - this item is " + strUni);
            //    }
